...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LoginSignUpWidget() : LogoWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => GeneratedReportWidget(),
        ),
        FFRoute(
          name: '-Timer',
          path: '/Timer',
        ...
        FFRoute(
          name: '-Reserve-Bed',
          path: '/Reservebed',
          builder: (context, params) => ReserveBedWidget(),
        ),
        FFRoute(
          name: '-Patient-Info',
          path: '/PatientInfo',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Screenshot_2024-03-15_042827.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
